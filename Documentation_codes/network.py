...
async def main():
    ...
    async with AsyncWebCrawler() as crawler:
        ...
        # try:
        #     # Access the first CrawlResult object inside the container and get its attributes.
        #     keys = result[0].__dict__.keys()
            
        #     print("CrawlResult Attributes:")
        #     print(list(keys))
                
        # except IndexError:
        #     print("Error: The CrawlResultContainer is empty.")
        # except AttributeError:
        #     print("Error: The inner object does not support standard __dict__ attribute access.")
